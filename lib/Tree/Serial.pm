...
Let it default to non-existent, in the sense that L<exists|https://perldoc.pl/functions/exists> returns false on C<$deserializer{showMissing}>. Empty nodes will then not be rendered at all:
